        ...
        <Grid container xs={12}>
          <Grid item xs={12} md={4}>
            <Box className='services-box'>
              ...
              <img src={images.parkingIcon} className='servicesImages'></img>
              {/* </div> */}
          ...
          <Grid item xs={12} md={4}>
            <Box className='services-box'>
              ...
              {/* <div className='ser-image-box'> */}
              <img src={images.restrauntIcon} className='servicesImages'></img>
              {/* </div> */}
          ...
          <Grid item xs={12} md={4}>
            <Box className='services-box'>
              ...
              {/* <div className='ser-image-box'> */}
              <img src={images.wifiicon} className='servicesImages'></img>
              {/* </div> */}
